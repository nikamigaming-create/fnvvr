...
$checks = @(
    ...
    [ordered]@{ name="head_axis_basis"; applicable=$nativeStereoRun; pass=($launcher -match 'native head axis mode=openxr-to-ni-camera'); detail="native temporary-camera yaw/roll/pitch slots must receive the audited OpenXR-to-NiCamera basis conversion" },
